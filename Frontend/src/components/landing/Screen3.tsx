...
useEffect(() => {
  ...
  return (
    ...
    >
      <div className="mx-auto flex h-full w-full max-w-[1600px] items-center justify-center overflow-y-auto px-4 py-6">
        <div className="grid w-full grid-cols-1 gap-8 md:grid-cols-2">

          {/* Left Panel - Live Pipeline */}
          <div
            className="relative overflow-hidden rounded-[2rem] border p-8 shadow-[0_30px_80px_rgba(0,0,0,0.28)]"
            style={{
  ...
  {isCompleted && (
    <button
      ...
      className="flex items-center gap-1.5 rounded-full px-3 py-1.5 text-[11px] font-medium transition-colors hover:bg-white/10"
      style={{
    ...
    >
      ...
      New recording
              ...
              {/* Title */}
              <h2 className="mb-10 text-2xl font-bold leading-tight" style={{ color: 'rgba(255,255,255,0.95)' }}>
                {isCompleted ? 'Processing Done!' : 'Making sense of your audio...'}
              </h2>

              {/* Progress Container Layout Stack */}
              <div className="space-y-4 mt-10">
                ...
                {isTranscoding ? (
                  ...
                  <div className={`flex items-start gap-4 transition-all duration-500 ${!transcodingDone ? 'opacity-50' : ''}`}>
                    <div
                  ...
                  {lang && (
                    <div className="relative" ref={langDropdownRef}>
                      ...
                      >
                        ...
                        <span>{lang} → {selectedLangName}</span>
                        <svg
